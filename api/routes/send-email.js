...
var _default = (exports["default"] = /*#__PURE__*/ (function () {
  var _ref = _asyncToGenerator(
    /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(req, res) {
      var schema, _schema$validate, value, error, postmarkService;
            ...
            switch ((_context.prev = _context.next)) {
              case 0:
                schema = _medusaCoreUtils.Validator.object().keys({
                  TemplateId: _medusaCoreUtils.Validator.required(),
                  From: _medusaCoreUtils.Validator.string().required(),
                  To: _medusaCoreUtils.Validator.string().required(),
                  TemplateModel: _medusaCoreUtils.Validator.object()
                    .optional()
                    ["default"]({}),
                });
              ...
              case 4:
                _context.prev = 4;
                postmarkService = req.scope.resolve("postmarkService");
                _context.next = 8;
                return postmarkService.sendEmail(
                  value.template_id,
                  value.to,
                  value.data
                );
