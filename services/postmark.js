...
function _regeneratorRuntime() {
  ...
  function wrap(t, e, r, n) {
    var i = e && _instanceof(e.prototype, Generator) ? e : Generator,
  ...
  return _createClass(PostmarkService, [
    {
      ...
      value: (function () {
        var _getAbandonedCarts = _asyncToGenerator(
              ...
              function _callee4$(_context5) {
                while (1)
                  switch ((_context5.prev = _context5.next)) {
                      ...
                      if (
                        !(
                          !(
                            ...
                            _this$options_.abandoned_cart
                          ) ||
                          !(
                            (_this$options_2 = this.options_) !== null &&
                            _this$options_2 !== void 0 &&
                            (_this$options_2 =
                              _this$options_2.abandoned_cart) !== null &&
                            _this$options_2 !== void 0 &&
                            _this$options_2.enabled
                          ) ||
                          !(
                            (_this$options_3 = this.options_) !== null &&
                            _this$options_3 !== void 0 &&
                            (_this$options_3 =
                              _this$options_3.abandoned_cart) !== null &&
                            _this$options_3 !== void 0 &&
                            _this$options_3.first
                          )
                        )
                      ) {
                        _context5.next = 2;
                    ...
                    case 2:
                      ...
                      options =
                        ...
                        _this$options_4 === void 0
                          ? void 0
                          : _this$options_4.abandoned_cart;
                      now = new Date();
                      firstCheck = new Date(
                        now.getTime() -
                          parseInt(
                            options === null ||
                              options === void 0 ||
                              (_options$first = options.first) === null ||
                              _options$first === void 0
                              ? void 0
                              : _options$first.delay
                          ) *
                            60 *
                            60 *
                            1000
                      );
                      secondCheck = new Date(
                        now.getTime() -
                          parseInt(
                            options === null ||
                              options === void 0 ||
                              (_options$second = options.second) === null ||
                              _options$second === void 0
                              ? void 0
                              : _options$second.delay
                          ) *
                            60 *
                            60 *
                            1000
                      ...
                      thirdCheck = new Date(
                        now.getTime() -
                          parseInt(
                            options === null ||
                              options === void 0 ||
                              (_options$third = options.third) === null ||
                              _options$third === void 0
                              ? void 0
                              : _options$third.delay
                          ) *
                            60 *
                            60 *
                            1000
                      );
                      cartRepository = this.manager_.withRepository(
                        this.cartRepository_
                      );
                      lineItemRepository = this.manager_.withRepository(
                    ...
                    case 35:
                      if (
                        cartData.items.find(function (li) {
                          return (
                            (li === null || li === void 0
                              ? void 0
                              : li.updated_at) <= firstCheck
                          );
                        }) !== undefined &&
                        (cart === null ||
                        cart === void 0 ||
                        (_cart$metadata4 = cart.metadata) === null ||
                        _cart$metadata4 === void 0
                          ? void 0
                          : _cart$metadata4.third_abandonedcart_mail) !== true
                      )
                            ...
                            while (1)
                              switch ((_context4.prev = _context4.next)) {
                                case 0:
                                  ...
                                  items = _this2.processItems_(
                                    cart.items,
                                    cart !== null &&
                                      cart !== void 0 &&
                                      (_cart$region = cart.region) !== null &&
                                      _cart$region !== void 0 &&
                                      _cart$region.includes_tax
                                      ? 0
                                      : (cart === null ||
                                        cart === void 0 ||
                                        (_cart$region2 = cart.region) ===
                                          null ||
                                        _cart$region2 === void 0
                                          ? void 0
                                          : _cart$region2.tax_rate) / 100,
                                    cart === null ||
                                      cart === void 0 ||
                                      (_cart$region3 = cart.region) === null ||
                                      _cart$region3 === void 0
                                      ? void 0
                                      : _cart$region3.currency_code.toUpperCase()
                                  );
                                  sendOptions = {
                                    From: _this2.options_.from,
                                    to: cart.email,
                                    TemplateId: 0,
                                    TemplateModel: _objectSpread(
                                      _objectSpread({}, cart),
                                      {},
                                      {
                                        items: items,
                                  ...
                                  if (
                                    !(
                                      options !== null &&
                                      options !== void 0 &&
                                      (_options$third2 = options.third) !==
                                        null &&
                                      _options$third2 !== void 0 &&
                                      _options$third2.template &&
                                      (cart === null ||
                                      cart === void 0 ||
                                      (_cart$metadata = cart.metadata) ===
                                        null ||
                                      _cart$metadata === void 0
                                        ? void 0
                                        : _cart$metadata.third_abandonedcart_mail) !==
                                        true
                                    )
                                  ) {
                                    _context4.next = 10;
                                  ...
                                  sendOptions.TemplateId =
                                    options === null ||
                                    options === void 0 ||
                                    (_options$third3 = options.third) ===
                                      null ||
                                    _options$third3 === void 0
                                      ? void 0
                                      : _options$third3.template;
                                  _context4.next = 10;
                                  return _this2.client_
                                ...
                                case 12:
                                  if (
                                    !(
                                      options !== null &&
                                      options !== void 0 &&
                                      (_options$second2 = options.second) !==
                                        null &&
                                      _options$second2 !== void 0 &&
                                      _options$second2.template &&
                                      (cart === null ||
                                      cart === void 0 ||
                                      (_cart$metadata2 = cart.metadata) ===
                                        null ||
                                      _cart$metadata2 === void 0
                                        ? void 0
                                        : _cart$metadata2.second_abandonedcart_mail) !==
                                        true
                                    )
                                  ) {
                                    _context4.next = 16;
                                  ...
                                  sendOptions.TemplateId =
                                    options === null ||
                                    options === void 0 ||
                                    (_options$second3 = options.second) ===
                                      null ||
                                    _options$second3 === void 0
                                      ? void 0
                                      : _options$second3.template;
                                  _context4.next = 16;
                                  return _this2.client_
                                    .sendEmailWithTemplate(sendOptions)
                                    .then(
                                ...
                                case 18:
                                  if (
                                    !(
                                      options !== null &&
                                      options !== void 0 &&
                                      (_options$first2 = options.first) !==
                                        null &&
                                      _options$first2 !== void 0 &&
                                      _options$first2.template &&
                                      (cart === null ||
                                      cart === void 0 ||
                                      (_cart$metadata3 = cart.metadata) ===
                                        null ||
                                      _cart$metadata3 === void 0
                                        ? void 0
                                        : _cart$metadata3.first_abandonedcart_mail) !==
                                        true
                                    )
                                  ) {
                                    _context4.next = 22;
                                  ...
                                  sendOptions.TemplateId =
                                    options === null ||
                                    options === void 0 ||
                                    (_options$first3 = options.first) ===
                                      null ||
                                    _options$first3 === void 0
                                      ? void 0
                                      : _options$first3.template;
                                  _context4.next = 22;
                                  return _this2.client_
                                    .sendEmailWithTemplate(sendOptions)
                                    .then(
    ...
    },
    {
      ...
      value: (function () {
        var _remindUpsellOrders = _asyncToGenerator(
              ...
              function _callee6$(_context8) {
                while (1)
                  switch ((_context8.prev = _context8.next)) {
                      ...
                      if (
                        !(
                          !(
                            ...
                            _this$options_5.upsell
                          ) ||
                          !(
                            (_this$options_6 = this.options_) !== null &&
                            _this$options_6 !== void 0 &&
                            (_this$options_6 = _this$options_6.upsell) !==
                              null &&
                            _this$options_6 !== void 0 &&
                            _this$options_6.enabled
                          ) ||
                          !(
                            (_this$options_7 = this.options_) !== null &&
                            _this$options_7 !== void 0 &&
                            (_this$options_7 = _this$options_7.upsell) !==
                              null &&
                            _this$options_7 !== void 0 &&
                            _this$options_7.collection
                          ) ||
                          !(
                            (_this$options_8 = this.options_) !== null &&
                            _this$options_8 !== void 0 &&
                            (_this$options_8 = _this$options_8.upsell) !==
                              null &&
                            _this$options_8 !== void 0 &&
                            _this$options_8.delay
                          ) ||
                          !(
                            (_this$options_9 = this.options_) !== null &&
                            _this$options_9 !== void 0 &&
                            (_this$options_9 = _this$options_9.upsell) !==
                              null &&
                            _this$options_9 !== void 0 &&
                            _this$options_9.template
                          )
                        )
                      ) {
                        _context8.next = 2;
                    ...
                    case 2:
                      orderRepo = this.manager_.withRepository(
                        this.orderRepository_
                      );
                      options = this.options_.upsell;
                      validThrough = _luxon.DateTime.now()
                        .minus({
                          days: options.valid,
                        })
                      ...
                      return orderRepo.findBy({
                        created_at: (0, _typeorm.LessThan)(
                          new Date(
                            new Date().getTime() -
                              parseInt(options.delay) * 60 * 60 * 24 * 1000
                          )
                        ),
                      });
                    case 7:
                            ...
                            while (1)
                              switch ((_context7.prev = _context7.next)) {
                                case 0:
                                  ...
                                  if (
                                    !(
                                      ((_order$metadata = order.metadata) !==
                                        null &&
                                        _order$metadata !== void 0 &&
                                        _order$metadata.upsell_sent) ||
                                      order.created_at <
                                        new Date(
                                          new Date().getTime() -
                                ...
                                case 3:
                                  _context7.next = 5;
                                  return _this3.orderService_.retrieve(
                                    order.id,
                                    {
                                      select: ["id"],
                                      relations: [
                                ...
                                case 5:
                                    ...
                                    for (
                                      ...
                                      if (
                                        ...
                                        (_item$variant = item.variant) ===
                                          null ||
                                        _item$variant === void 0 ||
                                        (_item$variant =
                                          _item$variant.product) === null ||
                                        _item$variant === void 0
                                          ? void 0
                                          : _item$variant.collection_id) !==
                                        options.collection
                                      )
                                        upsell = false;
                                    }
                                  ...
                                  sendOptions = {
                                    ...
                                    TemplateModel: _objectSpread(
                                      _objectSpread(
                                        _objectSpread({}, orderData),
                                        _this3.options_.default_data
                                      ),
                                      {},
                                      {
                                  ...
                                  order.metadata = _objectSpread(
                                    _objectSpread({}, order.metadata),
                                    {},
                                    {
                                      upsell_sent: true,
                                    }
                                              ...
                                              function _callee5$(_context6) {
                                                while (1)
                                                  switch (
                                                    ...
                                                    case 0:
                                                      _context6.next = 2;
                                                      return _this3.orderService_.update(
                                                        order.id,
                                                        {
                                                          metadata:
                                                            order.metadata,
    ...
    },
    {
      ...
      value: (function () {
        var _fetchAttachments = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee7(
            ...
            var attachments,
              base64,
              _data$return_request,
              shipping_method,
              shipping_data,
              provider,
              lbl,
              _base,
              _this$options_$pdf$en,
              _this$options_10,
              _base2;
            return _regeneratorRuntime().wrap(
                ...
                while (1)
                  switch ((_context9.prev = _context9.next)) {
                    case 0:
                      ...
                      _context9.t0 = event;
                      _context9.next =
                        _context9.t0 === "user.password_reset"
                          ? 4
                          : _context9.t0 === "swap.created"
                          ? 16
                          : _context9.t0 === "order.return_requested"
                          ? 16
                          : _context9.t0 === "order.placed"
                          ? 41
                          : 54;
                      break;
                    case 4:
                      ...
                      if (
                        !(
                          attachmentGenerator &&
                          attachmentGenerator.createPasswordReset
                        )
                      ) {
                        _context9.next = 10;
                        break;
                    ...
                    case 16:
                      _context9.prev = 16;
                      (_data$return_request = data.return_request),
                        (shipping_method =
                          _data$return_request.shipping_method),
                        (shipping_data = _data$return_request.shipping_data);
                      if (!shipping_method) {
                        _context9.next = 24;
                        break;
                      }
                      ...
                      _context9.next = 22;
                      return this.fulfillmentProviderService_.retrieveDocuments(
                        provider,
                        shipping_data,
                        "label"
                      );
                    ...
                    case 29:
                      ...
                      _context9.next = 33;
                      return attachmentGenerator.createReturnInvoice(
                        data.order,
                    ...
                    case 41:
                      ...
                      if (
                        !(
                          ((_this$options_$pdf$en =
                            (_this$options_10 = this.options_) === null ||
                            _this$options_10 === void 0 ||
                            (_this$options_10 = _this$options_10.pdf) ===
                              null ||
                            _this$options_10 === void 0
                              ? void 0
                              : _this$options_10.enabled) !== null &&
                          _this$options_$pdf$en !== void 0
                            ? _this$options_$pdf$en
                            : false) &&
                          attachmentGenerator &&
                          attachmentGenerator.createInvoice
                        )
                      ) {
                        _context9.next = 47;
                        break;
                      ...
                      _context9.next = 45;
                      return attachmentGenerator.createInvoice(
                        this.options_,
                        data
                      );
                    case 45:
                ...
                while (1)
                  switch ((_context10.prev = _context10.next)) {
                    case 0:
                      _context10.t0 = event;
                      _context10.next =
                        _context10.t0 === "order.placed"
                          ? 3
                          : _context10.t0 === "order.shipment_created"
                          ? 4
                          : _context10.t0 === "order.canceled"
                          ? 5
                          : _context10.t0 === "user.password_reset"
                          ? 6
                    ...
                    case 3:
                      return _context10.abrupt(
                        "return",
                        this.orderPlacedData(eventData, attachmentGenerator)
                      );
                    case 4:
                      return _context10.abrupt(
                        "return",
                        this.orderShipmentCreatedData(
                          eventData,
                          attachmentGenerator
                        )
                      );
                    case 5:
                      return _context10.abrupt(
                        "return",
                        this.orderCanceledData(eventData, attachmentGenerator)
                      );
                    case 6:
                      return _context10.abrupt(
                        "return",
                        this.userPasswordResetData(
                          eventData,
                          attachmentGenerator
                        )
                      );
                ...
                while (1)
                  switch ((_context11.prev = _context11.next)) {
                    ...
                    case 20:
                      ...
                      if (data.locale && _typeof(templateId) === "object")
                        templateId =
                          templateId[data.locale] ||
                          Object.values(templateId)[0]; // Fallback to first template if locale is not found
                      if (!(templateId === null)) {
                        _context11.next = 24;
                        break;
                      }
                    ...
                    case 24:
                      sendOptions = {
                        ...
                        to:
                          (_data$email = data.email) !== null &&
                          _data$email !== void 0
                            ? _data$email
                            : data === null ||
                              data === void 0 ||
                              (_data$customer = data.customer) === null ||
                              _data$customer === void 0
                            ? void 0
                      ...
                      if (
                        (_this$options_11 = this.options_) !== null &&
                        _this$options_11 !== void 0 &&
                        _this$options_11.bcc
                      )
    ...
    },
    {
      ...
      value: (function () {
        var _resendNotification = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee10(
            ...
            return _regeneratorRuntime().wrap(
              function _callee10$(_context12) {
                while (1)
                  switch ((_context12.prev = _context12.next)) {
                    case 0:
                      sendOptions = _objectSpread(
                        _objectSpread({}, notification.data),
                        {},
                        {
    ...
    },
    {
      ...
      value: (function () {
        var _sendMail = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee11(options) {
            return _regeneratorRuntime().wrap(
              function _callee11$(_context13) {
                while (1)
                    ...
                    case 0:
                      ...
                      this.client_.sendEmailWithTemplate(
                        _objectSpread(
                          ...
                          {
                            TemplateModel: _objectSpread(
                              _objectSpread({}, options.TemplateModel),
                              this.options_.default_data
                            ),
                          }
                        )
    ...
    },
    {
      ...
      value: (function () {
        var _orderShipmentCreatedData = _asyncToGenerator(
    ...
    },
    {
      ...
      value: (function () {
        var _orderCanceledData = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee13(_ref7) {
            var id,
              order,
              subtotal,
              tax_total,
                      ...
                      return _context15.abrupt(
                        ...
                        _objectSpread(
                          ...
                          {},
                          {
                            ...
                            tax_total: ""
                              .concat(
                                this.humanPrice_(tax_total, currencyCode),
                                " "
                              )
                              .concat(currencyCode),
                            discount_total: ""
                            ...
                            total: ""
                              .concat(
                                this.humanPrice_(total, currencyCode),
                                " "
                              )
                              .concat(currencyCode),
                          }
    ...
    },
    {
      key: "giftCardData",
      value: (function () {
        var _giftCardData = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee14(_ref8) {
            var _data$order$email;
            var id, data;
            return _regeneratorRuntime().wrap(
              function _callee14$(_context16) {
                while (1)
                    ...
                    case 3:
                      ...
                      return _context16.abrupt(
                        ...
                        _objectSpread(
                          ...
                          {
                            email:
                              (_data$order$email = data.order.email) !== null &&
                              _data$order$email !== void 0
                                ? _data$order$email
                                : "",
                          }
                        )
    ...
    },
    {
      key: "orderPlacedData",
      value: (function () {
        var _orderPlacedData = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee16(_ref9) {
            var _this4 = this,
                        ...
                        order.items.map(
                          /*#__PURE__*/ (function () {
                            var _ref10 = _asyncToGenerator(
                              /*#__PURE__*/ _regeneratorRuntime().mark(
                                function _callee15(i) {
                                  return _regeneratorRuntime().wrap(
                                    function _callee15$(_context17) {
                                      while (1)
                                        switch (
                                          ...
                                          case 0:
                                            _context17.next = 2;
                                            return _this4.totalsService_.getLineItemTotals(
                                              i,
                                              order,
                                              {
                                                include_tax: true,
                      ...
                      return _context18.abrupt(
                        ...
                        _objectSpread(
                          ...
                          {},
                          {
                            ...
                            subtotal_ex_tax: ""
                              .concat(
                                this.humanPrice_(subtotal_ex_tax, currencyCode),
                                " "
                              )
                              .concat(currencyCode),
                            subtotal: ""
                              .concat(
                                this.humanPrice_(subtotal, currencyCode),
                                " "
                              )
                              .concat(currencyCode),
                            gift_card_total: ""
                              .concat(
                                this.humanPrice_(gift_card_total, currencyCode),
                                " "
                              )
                              .concat(currencyCode),
                            tax_total: ""
                            ...
                            discount_total: ""
                              .concat(
                                this.humanPrice_(discountTotal, currencyCode),
                                " "
                              )
                              .concat(currencyCode),
                            shipping_total: ""
                              .concat(
                                this.humanPrice_(shipping_total, currencyCode),
                                " "
                              )
                              .concat(currencyCode),
                            shipping_total_inc: ""
                              .concat(
                                this.humanPrice_(
                                  ...
                                  order === void 0 ||
                                  (_order$shipping_metho =
                                    order.shipping_methods[0]) === null ||
                                  _order$shipping_metho === void 0
                                    ? void 0
                                    : _order$shipping_metho.price) ||
                                    shipping_total,
                                  currencyCode
                                ),
                                " "
          ...
          return _objectSpread(
            ...
            {},
            {
              ...
              price: ""
                .concat(currencyCode, " ")
                .concat(
                  _this5.humanPrice_(i.unit_price * (1 + taxRate), currencyCode)
                ),
            }
          );
        });
    ...
    },
    {
      ...
      value: function humanPrice_(amount, currency) {
        ...
        return normalized.toFixed(
          _medusaCoreUtils.zeroDecimalCurrencies.includes(
    ...
    },
    {
      ...
      value: function normalizeThumbUrl_(url) {
        ...
        else if (url.startsWith("//")) return "https:".concat(url);
        return url;
      },
    },
    {
      key: "extractLocale",
      value: (function () {
        var _extractLocale = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee17(
            fromOrder
          ) {
            var cart;
            return _regeneratorRuntime().wrap(
              function _callee17$(_context19) {
                while (1)
